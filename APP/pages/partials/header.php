...
<head>
    ...
    <link rel="shortcut icon" href="<?php echo $base?>/assets/images/favicon-16x16.png" type="image/x-icon">
    <script src="<?php echo $base?>/assets/js/main.js" defer></script>
    <script src="https://kit.fontawesome.com/e54953dbf5.js" crossorigin="anonymous"></script>
